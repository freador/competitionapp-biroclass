class RankingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @ranking.update(ranking_params)
        format.html { redirect_to @ranking, notice: "Ranking was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to rankings_path, notice: "Ranking was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def ranking_params
      params.expect(ranking: [ :participant_id, :competition_id, :total_score, :position ])
    end
end
