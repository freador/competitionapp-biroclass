class CompetitionsController < ApplicationController
  ...
  def index
    @competitions = Competition.includes(:owner).order(created_at: :desc)
  end

  def public_index
    @competitions = Competition.publicly_visible.includes(:owner)
  end
  ...
  private
    ...
    def competition_params
      params.expect(competition: [ :title, :description, :rules, :status, :owner_id ])
    end
