...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference("Competition.count") do
      post competitions_url, params: { competition: { description: @competition.description, owner_id: @competition.owner_id, rules: @competition.rules, status: @competition.status, title: @competition.title } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { description: @competition.description, owner_id: @competition.owner_id, rules: @competition.rules, status: @competition.status, title: @competition.title } }
