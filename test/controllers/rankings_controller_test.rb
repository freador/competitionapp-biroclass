...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference("Ranking.count") do
      post rankings_url, params: { ranking: { competition_id: @ranking.competition_id, participant_id: @ranking.participant_id, position: @ranking.position, total_score: @ranking.total_score } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { competition_id: @ranking.competition_id, participant_id: @ranking.participant_id, position: @ranking.position, total_score: @ranking.total_score } }
