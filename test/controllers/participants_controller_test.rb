...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference("Participant.count") do
      post participants_url, params: { participant: { competition_id: @participant.competition_id, name: @participant.name, user_id: @participant.user_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { competition_id: @participant.competition_id, name: @participant.name, user_id: @participant.user_id } }
